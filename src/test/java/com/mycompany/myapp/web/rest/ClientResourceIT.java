 ...
 *//*
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().name(DEFAULT_NAME).age(DEFAULT_AGE);
        return client;
    }
 ...
 *//*
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().name(UPDATED_NAME).age(UPDATED_AGE);
        return client;
    }
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.name(UPDATED_NAME).age(UPDATED_AGE);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.name(UPDATED_NAME).age(UPDATED_AGE);
