...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'Vélo avocat' };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('Coordinateur');
      cy.get(`[data-cy="name"]`).should('have.value', 'Coordinateur');

      cy.get(`[data-cy="description"]`).type('Variété parmi');
      cy.get(`[data-cy="description"]`).should('have.value', 'Variété parmi');

      cy.get(`[data-cy="amount"]`).type('6167');
      cy.get(`[data-cy="amount"]`).should('have.value', '6167');
